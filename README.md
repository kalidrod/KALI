...
**KALIDROD**
---
[![Instagram](https://img.shields.io/badge/Instagram-Follow-E4405F?style=for-the-badge&logo=instagram&logoColor=white)](https://instagram.com/ur_.krish._02)
---
...
```bash
git clone https://github.com/kalidrod/KALI.git
cd KALI && bash install.sh
```
...
```bash
FRESH=1 KALI_PASS=changeme bash install.sh
```
...
## Maintained by [KRISHN](https://github.com/krishn-145)
